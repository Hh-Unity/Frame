...
namespace ShootingEditor2D
{
    ...
    public class GunConfigModel : AbstractSystem,IGunConfigModel
    {
        private Dictionary<string, GunConfigItem> m_gunConfigItem = new Dictionary<string, GunConfigItem>()
        {
