...
namespace ShootingEditor2D
{
    public class UIController : MonoBehaviour,IController
    {
        ...
        private void OnGUI()
        {
            ...
            GUI.Label(new Rect(10, 60, 300, 100), $"枪内子弹:{m_gunSystem.CurrentGun.BulletCountInGun.Value}/3", mLabelStyle.Value);
            GUI.Label(new Rect(10, 110, 300, 100), $"枪外子弹:{m_gunSystem.CurrentGun.BulletCountOutGun.Value}/3", mLabelStyle.Value);
            GUI.Label(new Rect(10, 160, 300, 100), $"枪械名称:{m_gunSystem.CurrentGun.Name.Value}/3", mLabelStyle.Value);
            GUI.Label(new Rect(10, 210, 300, 100), $"枪械状态:{m_gunSystem.CurrentGun.State.Value}/3", mLabelStyle.Value);
